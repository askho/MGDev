...
function getAlbumThumbs(categoryID) {
    ...
    .done(function( data ) {
        $("#content").html("<h1>Edit Albums</hi>");
        ...
        for(i = 0; i < data.length; i++) {
            ...
            $("#isotopeContainer").append("<form action='php/edit_album.php' method='post' id=form"+data[i]['categoryID']+" enctype='multipart/form-data'>"
                                          ...
                                          +"<input type='submit' value='Rename' name='rename'><br>"
                                          +"<a href = '"+url+"' id ='"+albumName+"'>viewme</a>"                                           +"</form>");
    ...
    .done(function( data ) {
        if(data == ""){
            ...
            for(i = 0; i < data.length; i++) {
                ...
                $("#editCategories").hide().append().fadeIn("fast");
                (function(j) {
